...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.register = function (request, response, body) {
        return __awaiter(this, void 0, void 0, function () {
            var email, password, firstName, middleName, lastName, userName, phone, city, state, country, userExists, hashedPassword, userData, userCreate, id, token, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        email = body.email, password = body.password, firstName = body.firstName, middleName = body.middleName, lastName = body.lastName, userName = body.userName, phone = body.phone, city = body.city, state = body.state, country = body.country;
