...
var register_service_1 = __importDefault(require("./register.service"));
...
var RegisterController = /** @class */ (function () {
    ...
    RegisterController.prototype.register = function (request, response, body) {
        return __awaiter(this, void 0, void 0, function () {
            var name_1, email, password, userExists, hashedPassword, userData, userCreate, id, token, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        name_1 = body.name, email = body.email, password = body.password;
                        return [4 /*yield*/, this.registerService.findOne({ email: email })];
                    case 1:
                        userExists = _a.sent();
                        if (userExists)
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.registerService.create(userData)];
                    case 3:
                        userCreate = _a.sent();
                        id = userCreate._id;
                        ...
                        return [2 /*return*/, response.formatter.ok(__assign(__assign({}, userData), { token: token }), true, "USER_REGISTER_SUCCESS")];
                    case 4:
                        error_1 = _a.sent();
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [Object, Object, register_validator_1.RegisterDTO]),
